...
const LikePane: Component = () => {
  ...
  return (
    <div
      id="like-page"
      class="bg-white flex flex-col text-white p-8 h-dvh overflow-y-hidden"
    >
      <div class="flex items-center justify-between mb-8 ms-6 gap-2 text-green-900">
        <div class="flex flex-row gap-2">
          <HeartPlus></HeartPlus>
        </div>
        <h2 class="lg:block hidden font-[Oi] text-2xl lg:text-4xl whitespace-nowrap">
          The Meowcounter
        </h2>
      ...
      <div class="flex items-center grow-1 pb-16 justify-center relative text-green-900">
        ...
        <div class="relative flex flex-col items-center">
          ...
          <p class="font-[Sora] text-center lg:text-4xl text-2xl">
      ...
      <h2 class="text-green-900 block absolute bottom-8 lg:hidden font-[Oi] text-2xl">
        The Meowcounter
      </h2>
    </div>
  );
