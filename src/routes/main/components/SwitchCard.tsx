...
export function SwitchCard(props: SwitchCardProps) {
  ...
  return (
    <button
      ...
      class={`flex w-full max-lg:outline-2 max-lg:-outline-offset-2 max-lg:outline-white max-lg:text-white transition-all flex-col bg-zinc-900 max-lg:bg-black cursor-pointer outline-1 z-1 outline-transparent lg:hover:outline-white lg:hover:scale-97 rounded-4xl py-2`}
    >
