...
export default function Banking() {
  let [copied, setCopied] = createSignal<boolean>(false);

  return (
    <div class="flex flex-col min-h-svh w-full justify-between p-8 ">
      <div class="flex flex-col gap-4">
        ...
        <hr class="text-white opacity-50 mb-4 mt-2 h-1" />
        <a
          target="_blank"
        ...
        >
          ...
          >
            <g id="g5">
              <path d="M 8.1,10.7 H 0 v 32.8 h 8.1 z" id="path1"></path>
              <path
                d="M 33.6,12.6 C 33.6,5.6 27.9,0 21,0 H 0 v 7 h 19.9 c 3.2,0 5.8,2.5 5.8,5.5 0,1.5 -0.5,3 -1.6,4.1 -1.1,1.1 -2.5,1.7 -4,1.7 h -7.8 c -0.3,0 -0.5,0.2 -0.5,0.5 V 25 c 0,0.1 0,0.2 0.1,0.3 l 13.2,18.3 h 9.6 L 21.6,25.2 c 6.6,-0.3 12,-5.9 12,-12.6 z"
                id="path2"
              ></path>
            </g>
          </svg>
        ...
        >
          <div class="flex flex-col gap-2">
            <div class="flex flex-row items-center gap-2">
              ...
              <span class="text-2xl text-white pt-1">T-Bank</span>
            </div>
            <span class="text-md leading-5">
              Russia and other countries not supported by above, in rubles
            </span>
          </div>
        </a>
      </div>
      <div class="flex flex-col gap-4">
        <hr class="text-white opacity-50 h-1" />
        <p class="text-5xl text-white">Non-money</p>
        <div class="flex flex-row gap-4">
          ...
          <button
            class="flex leading-5 flex-row font-[Overpass] text-start grow-1 gap-2 items-center py-3 px-4 outline-white outline-2 rounded-xl text-white"
            onClick={() => {
              navigator.clipboard.writeText("https://tarakoshka.tech/");
              setCopied(true);
            }}
          >
            {copied() ? (
              <>
                URL copied. Thank you!
                <svg
                  xmlns="http://www.w3.org/2000/svg"
